...
Changelog:
  ...
  - v1.1.0: Added Google Drive mount and GPU Mel-Spec processing.
  - v1.2.0 (2026-04-13): Made strictly self-contained. Integrated Dataset 
                         and Architecture classes directly to resolve Colab 
                         ModuleNotFoundError.
"""

from google.colab import drive
# Force remount ensures it doesn't hang if already mounted
...
class JamendoFairnessDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # Deterministic center crop for evaluation (more stable than random)
